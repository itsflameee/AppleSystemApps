...
## Что это?
В этом репозитории можно найти множество системных приложений, которые были предварительно извлечены из прошивки iOS 18.7.9 для iPhone XS ([iPhone11,2,iPhone11,4,iPhone11,6_18.7.9_22H355_Restore.ipsw](https://ipsw.me/download/iPhone11,2/22H355/)). Все тесты совместимости происходили на iPhone 14 Pro Max с iOS 18.6.2, используя LiveContainer для сайдлоада всех системных приложений. Ниже будет приведён список приложений в виде таблицы.
...
## Список приложений
### (из прошивки iPhone XS 18.7.9, тестировались на iPhone 14 Pro Max with iOS 18.6.2)
